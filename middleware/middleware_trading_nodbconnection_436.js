...
APP_ID = `${process.env.APP_ID_TRADING}`
APP_KEY = `${process.env.APP_KEY_TRADING}`
APP_SECRET = `${process.env.APP_SECRET_TRADING}`
APP_CLUSTER = `${process.env.APP_CLUSTER_TRADING}`

// Channel setup
var channel_name			= 'private-trading-production-request.436'
...
privateChannel.bind(trade_request_event, function(data) {
