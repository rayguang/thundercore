...
namespace BfxAPI
{
    ...
    class BitfinexAPI
    {
        ...
        static constexpr auto WITHDRAWAL_CONF_FILE_PATH = "config/bitfinex/withdraw.conf";
        #endif
    ...
    public:
        ...
        BitfinexAPI& cancelOrder(const string &order_id)
        {
        ...
        BitfinexAPI& replaceOrder(const string &order_id,
                                  const string &symbol,
                                  const double &amount,
                                  const double &price,
                                  const string &side,
        ...
        BitfinexAPI& getOrderStatus(const string &order_id)
        {
        ...
        BitfinexAPI& claimPosition(const long long &position_id,
                                   const double &amount)
        {
        ...
        BitfinexAPI& cancelOffer(const string &offer_id)
        {
        ...
        BitfinexAPI& getOfferStatus(const string &offer_id)
        {
        ...
        BitfinexAPI& closeLoan(const string &offer_id)
        {
            string params = "{\"request\":\"/v1/funding/close\",\"nonce\":\"" +
            getTonce() + "\"";
            params += ",\"swap_id\":\"" + offer_id + "\"";
            params += "}";
