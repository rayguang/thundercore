...
int main() {
	...
	string api_key 		= "CjmkwSP57BYJoVqvSHf4pzDGCAiHiW0TFglZlVLJtz5XQXpV03vpa8oQbR5fMsKV";
	string secret_key 	= "M9NcEE96OOdqAFIvznl06huGmr10GUxd32IK6kN4zvx6TmxPXiawNyKWRkgWi6NR";

	BinaCPP_websocket bina_socket;
	BinaCPP bina;
	...
	bina.get_depth( symbol.c_str(), 3, result ) ;
	...
	BinaCPP_websocket::init();
 	...
 	BinaCPP_websocket::connect_endpoint( ws_depth_onData ,"/ws/!ticker@arr" ); 
