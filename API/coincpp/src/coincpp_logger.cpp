...
int    CoinCPP_logger::debug_level   = 1;
string CoinCPP_logger::debug_log_file = "/tmp/coinwatch.log";
int    CoinCPP_logger::debug_log_file_enable = 0;
FILE  *CoinCPP_logger::log_fp = NULL;



//-----------------------------------------------
void 
CoinCPP_logger::write_log( const char *fmt, ... ) 
{
    if ( debug_level == 0 ) {
        return;
    }
...
void 
CoinCPP_logger::write_log_clean( const char *fmt, ... ) 
{
    if ( debug_level == 0 ) {
        return;
    }
...
//---------------------
void 
CoinCPP_logger::open_logfp_if_not_opened() {
...
//---------------------
void 
CoinCPP_logger::set_debug_level( int level ) 
{
    debug_level = level;
}
...
//--------------------
void 
CoinCPP_logger::set_debug_logfile( string &pDebug_log_file ) 
{
...
//--------------------
void 
CoinCPP_logger::enable_logfile( int pDebug_log_file_enable ) 
{
