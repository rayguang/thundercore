...
int    BitxCPP_logger::debug_level   = 1;
string BitxCPP_logger::debug_log_file = "/tmp/bitxwatch.log";
int    BitxCPP_logger::debug_log_file_enable = 0;
FILE  *BitxCPP_logger::log_fp = NULL;



//-----------------------------------------------
void 
BitxCPP_logger::write_log( const char *fmt, ... ) 
{
    if ( debug_level == 0 ) {
        return;
    }
...
void 
BitxCPP_logger::write_log_clean( const char *fmt, ... ) 
{
    if ( debug_level == 0 ) {
        return;
    }
...
//---------------------
void 
BitxCPP_logger::open_logfp_if_not_opened() {
...
//---------------------
void 
BitxCPP_logger::set_debug_level( int level ) 
{
    debug_level = level;
}
...
//--------------------
void 
BitxCPP_logger::set_debug_logfile( string &pDebug_log_file ) 
{
...
//--------------------
void 
BitxCPP_logger::enable_logfile( int pDebug_log_file_enable ) 
{
