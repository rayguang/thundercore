...
int    KrakCPP_logger::debug_level   = 1;
string KrakCPP_logger::debug_log_file = "/tmp/krakwatch.log";
int    KrakCPP_logger::debug_log_file_enable = 0;
FILE  *KrakCPP_logger::log_fp = NULL;



//-----------------------------------------------
void 
KrakCPP_logger::write_log( const char *fmt, ... ) 
{
    if ( debug_level == 0 ) {
        return;
    }
...
void 
KrakCPP_logger::write_log_clean( const char *fmt, ... ) 
{
    if ( debug_level == 0 ) {
        return;
    }
...
//---------------------
void 
KrakCPP_logger::open_logfp_if_not_opened() {
...
//---------------------
void 
KrakCPP_logger::set_debug_level( int level ) 
{
    debug_level = level;
}
...
//--------------------
void 
KrakCPP_logger::set_debug_logfile( string &pDebug_log_file ) 
{
...
//--------------------
void 
KrakCPP_logger::enable_logfile( int pDebug_log_file_enable ) 
{
